    ...
    >
      <div className="relative flex h-full flex-col overflow-hidden rounded-[var(--ds-rounded-xxl)] border border-[var(--ds-hairline)] bg-[var(--ds-surface-1)]">
        ...
        <SidebarFooter className="relative px-3.5 py-3">
          <Show when="signed-in">
            <div className="flex items-center gap-2 rounded-[var(--ds-rounded-lg)] px-1 py-1">
              <UserButton
                showName
                appearance={{
                  elements: {
                    rootBox: "w-full",
                    userButtonBox: "w-full justify-start gap-2.5",
                    userButtonOuterIdentifier: "text-[13px] font-medium text-[var(--ds-ink)] truncate",
                    avatarBox: "h-8 w-8",
                  },
                }}
              />
